//
//  JXBaseCollectionViewFlowLayout.h
//  DRArtisan
//
...
//
#define BaseFlowLayout(w,h,marginW,marginH) [JXBaseCollectionViewFlowLayout LayoutWithItemSize:fSize(w,h) minMarginSize:fSize(marginW,marginH) sectionInset:UIEdgeInsetsZero]

@interface JXBaseCollectionViewFlowLayout : UICollectionViewFlowLayout
